...
const _chalk = /*#__PURE__*/ _interop_require_default(__webpack_require__(40499));
...
const _requestcookies = __webpack_require__(93983);
const _headers = __webpack_require__(76376);
const _cookies = __webpack_require__(45557);
const _requestasyncstorage = __webpack_require__(77888);
const _actionasyncstorage = __webpack_require__(51851);
const _staticgenerationbailout = __webpack_require__(87410);
const _draftmode = __webpack_require__(86149);
function headers() {
...
let chalk;
if (false) {} else {
    chalk = __webpack_require__(59546);
}
...
const _headers = __webpack_require__(76376);
const _constants = __webpack_require__(55111);
function getCookieParser(headers) {
    return function parseCookie() {
        ...
        const { parse: parseCookieFn } = __webpack_require__(64667);
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(64667);
...
const _apiutils = __webpack_require__(60701);
...
const _requestcookies = __webpack_require__(93983);
const _cookies = __webpack_require__(45557);
const _draftmodeprovider = __webpack_require__(60378);
...
const _http = __webpack_require__(66517);
const _responsehandlers = __webpack_require__(70172);
...
const _cookies = __webpack_require__(94144);
const _nexturl = __webpack_require__(99613);
const _cleanurl = __webpack_require__(47373);
...
const _notfound = __webpack_require__(83032);
const _redirect = __webpack_require__(78194);
const _responsehandlers = __webpack_require__(70172);
...
const _routemodule = __webpack_require__(96422);
const _requestasyncstoragewrapper = __webpack_require__(31205);
const _staticgenerationasyncstoragewrapper = __webpack_require__(26406);
const _responsehandlers = __webpack_require__(70172);
const _http = __webpack_require__(66517);
const _patchfetch = __webpack_require__(45018);
const _tracer = __webpack_require__(75907);
const _constants = __webpack_require__(43605);
const _getpathnamefromabsolutepath = __webpack_require__(81865);
const _proxyrequest = __webpack_require__(73869);
const _resolvehandlererror = __webpack_require__(86134);
const _log = /*#__PURE__*/ _interop_require_wildcard(__webpack_require__(17149));
const _autoimplementmethods = __webpack_require__(62954);
const _getnonstaticmethods = __webpack_require__(97401);
const _requestcookies = __webpack_require__(93983);
const _routekind = __webpack_require__(10285);
const _parsedurlquerytoparams = __webpack_require__(51696);
...
const headerHooks = __webpack_require__(73438);
...
const _detectdomainlocale = __webpack_require__(78287);
const _formatnextpathnameinfo = __webpack_require__(23028);
const _gethostname = __webpack_require__(7470);
const _getnextpathnameinfo = __webpack_require__(5105);
...
const _formatnextpathnameinfo = __webpack_require__(85392);
const _gethostname = __webpack_require__(52453);
const _getnextpathnameinfo = __webpack_require__(14893);
const REGEX_LOCALHOST_HOSTNAME = /(?!^https?:\/\/)(127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|\[::1\]|localhost)/;
function parseURL(url, base) {
    return new URL(String(url).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"), base && String(base).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"));
}
...
const _reflect = __webpack_require__(44158);
...
const _cookies = __webpack_require__(94144); //# sourceMappingURL=cookies.js.map
...
const _nexturl = __webpack_require__(26841);
const _utils = __webpack_require__(31120);
const _error = __webpack_require__(17362);
const _cookies = __webpack_require__(72135);
...
const _uaparserjs = /*#__PURE__*/ _interop_require_default(__webpack_require__(62851));
function _interop_require_default(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
    };
...
const _addpathprefix = __webpack_require__(22086);
const _pathhasprefix = __webpack_require__(4573);
...
const _addpathprefix = __webpack_require__(97423);
const _pathhasprefix = __webpack_require__(53684);
function addLocale(path, locale, defaultLocale, ignorePrefix) {
    // If no locale was given or the locale is the default locale, we don't need
    // to prefix the path.
    if (!locale || locale === defaultLocale) return path;
...
const _parsepath = __webpack_require__(18345);
...
const _parsepath = __webpack_require__(73224);
function addPathPrefix(path, prefix) {
    if (!path.startsWith("/") || !prefix) {
        return path;
    }
...
const _removetrailingslash = __webpack_require__(91190);
const _addpathprefix = __webpack_require__(22086);
const _addpathsuffix = __webpack_require__(15670);
const _addlocale = __webpack_require__(77743);
...
const _addpathprefix = __webpack_require__(97423);
const _addpathsuffix = __webpack_require__(46606);
const _addlocale = __webpack_require__(34743);
function formatNextPathnameInfo(info) {
    let pathname = (0, _addlocale.addLocale)(info.pathname, info.locale, info.buildId ? undefined : info.defaultLocale, info.ignorePrefix);
    if (info.buildId || !info.trailingSlash) {
        pathname = (0, _removetrailingslash.removeTrailingSlash)(pathname);
...
const _normalizelocalepath = __webpack_require__(68798);
const _removepathprefix = __webpack_require__(27507);
const _pathhasprefix = __webpack_require__(4573);
...
const _removepathprefix = __webpack_require__(92185);
const _pathhasprefix = __webpack_require__(53684);
function getNextPathnameInfo(pathname, options) {
    var _options_nextConfig;
    const { basePath, i18n, trailingSlash } = (_options_nextConfig = options.nextConfig) != null ? _options_nextConfig : {};
...
const serverExports = {
    NextRequest: (__webpack_require__(59620).NextRequest),
    NextResponse: (__webpack_require__(41338)/* .NextResponse */ .x),
    ImageResponse: (__webpack_require__(35294)/* .ImageResponse */ .E),
    userAgentFromString: (__webpack_require__(98551).userAgentFromString),
    userAgent: (__webpack_require__(98551).userAgent)
};
